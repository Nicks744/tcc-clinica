...
<%
    ...
    if (email != null && senha != null) {
        try {
            ...
            String sql = "SELECT tipo, rg FROM usuarios WHERE email = ? AND senha = ?";
            ...
            if (resultado.next()) {
                ...
                String rg = resultado.getString("rg"); // Busca o rg do usuário

                // Criar sessão para armazenar login e rg
                session.setAttribute("usuarioLogado", email);
                session.setAttribute("tipo", tipoUsuario);
                session.setAttribute("rg", rg); // Armazenando o rg na sessão
