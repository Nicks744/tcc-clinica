...
<%
    ...
    String cpf = (String) sessao.getAttribute("cpf"); // Aqui estamos pegando o RG da sessão
...
<div class="container">
    ...
    <section class="pets">
        ...
        <%
            ...
            try {
                ...
                String sqlPets = "SELECT id, nome, especie, raca, idade, sexo FROM animais WHERE cpf = ?";
                PreparedStatement stmtPets = conexao2.prepareStatement(sqlPets);
                stmtPets.setString(1, cpf); // Utilizando o RG da sessão
    ...
    <div class="actions">
        ...
        <button onclick="window.location.href='telaLoginSucesso.jsp'" class="logout">Voltar</button>
    </div>
</div>
