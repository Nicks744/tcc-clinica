...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) { 
        ...
        if (nomeUsuario == null || email == null || senhaUsuario == null) {
            ...
            if (!nomeUsuario.isEmpty() && !email.isEmpty() && !senhaUsuario.isEmpty()) {
                try {
                    ...
                    try (
                        ...
                        if (resultado.next()) {
                            ...
                            try (PreparedStatement stmt = conexao.prepareStatement(
                                "INSERT INTO usuarios (nome, email, senha, rg) VALUES (?, ?, ?, ?)")
                            ) {
