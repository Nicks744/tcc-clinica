<%
    HttpSession sessao = request.getSession(false); // não cria nova sessão

    if (sessao == null || sessao.getAttribute("usuarioLogado") == null) {
        response.sendRedirect("telaLogin.html"); // redireciona se não estiver logado
        return;
    }
%>
...
<header>
  ...
  <img src="usuario.jpg" alt="Usuário" class="avatar" onclick="togglePerfil()" />
  <div id="perfilDropdown" class="perfil-dropdown d-none">
    <img src="usuario.jpg" alt="Usuário" class="avatar-grande">
