...
<%
    ...
    String rgSessao = (String) session.getAttribute("rg");

    if (rgSessao == null) {
%>
        <p style='color: red;'>Erro: rgSessao não encontrado. Por favor, faça login novamente.</p>
        <%
        return;
    }
...
<%
        ...
        String sqlCadastroPet = "INSERT INTO animais (nome, especie, raca, idade, sexo, rg_dono) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        stmtCadastroPet.setString(6, rgSessao);
